...
5. เพิ่มรายรับเป็นตัวเลข หรือเลือกสลิป K PLUS / Dime / ธนาคารที่มี QR เพื่ออ่านยอด ชื่อผู้รับ วันที่ และเวลา
6. ตรวจสอบรายการก่อนบันทึก แล้วแตะรายละเอียดเพื่อเลือกหรือเพิ่มหมวดเอง แก้ไข ลบ และดูรูปสลิปต้นฉบับในเครื่องได้
...
GitHub Actions บิลด์ APK ทุกครั้งที่ push โดยตรวจ text integrity ก่อน build และแนบ APK กับ SHA-256 เป็น artifact เมื่อ push tag รูปแบบ `v*` จะสร้าง GitHub Release จาก `RELEASE_NOTES.md`
