...
object CategoryStore {
    ...
    val expenseDefaults = listOf(
        "อาหาร", "เดินทาง, รถ", "ของใช้จำเป็น", "ช้อปปิ้ง",
        "บันเทิง", "บ้าน, สาธารณูปโภค", "สุขภาพ, ดูแลตัวเอง", "ครอบครัว, สัตว์เลี้ยง",
        "ให้คนอื่น", "ท่องเที่ยว", "การศึกษา", "งาน, ธุรกิจ",
        "ชำระหนี้", "โอนเงิน", "ยังไม่จัดหมวด",
    )
